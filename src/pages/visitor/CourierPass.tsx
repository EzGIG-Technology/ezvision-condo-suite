      ...
      {!unit ? (
        ...
        <>
          ...
          <div className="card flex flex-col gap-2 p-4 text-[13.5px]">
            ...
            <p className="flex gap-2"><MapPin className="mt-0.5 h-4 w-4 shrink-0 text-brand" />Stop at the guardhouse, show this QR. The guard takes a photo of your IC.</p>
