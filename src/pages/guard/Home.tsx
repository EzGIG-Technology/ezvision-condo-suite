...
import { AlertTriangle, ArrowRight, Bike, Car, ClipboardPen, Clock, LogIn, LogOut, MessageCircle, Package, Phone, Route, ScanLine, UserPlus } from 'lucide-react';
...
const TILES = [
  ...
  { to: '/guard/riders', label: 'Rider', sub: 'Food and courier riders', icon: Bike, tone: 'bg-[#0E7490]' },
