...
export function makeSeed() {
  ...
  const visits: Visit[] = [
    ...
    { id: 'v-5', name: 'GrabFood rider', phone: '014-880 8810', type: 'rider', unit: 'B-12-05', host: 'Lim Wei Jie', plate: 'WTK 5520', status: 'on_site', entry: 'Walk-in · guard', checkIn: ago(12), validFrom: ago(12), validTo: ago(-8), verification: 'IC scanned', selfie: false, faceVariant: 8, people: 1, createdBy: 'guard', zone: 'unit', platform: 'GrabFood' },
